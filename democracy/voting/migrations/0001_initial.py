...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('votes', (
            ...
            ('time_stamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ...
            ('api_interface', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
    ...
    models = {
        ...
        'voting.vote': {
            ...
            'api_interface': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
