...
take inside of the edemocracy game. Functionality in this module should not depend
on request objects. Scripts on the server, the API views and the web views 
should all call into this module to play the dedemocracy game.

This module itself uses functions from the score.py and levels.py see if
an action is allowed and how it affects the score of the players / the edemocracy
world.
...
import score
import levels
from edemocracy.gamelogic.models import roles
...
def tag(user, issue, tag_string):
    # The idea behind tagging in edemocracy:
    ...
    # poinst scored through a tag showing up in edemocracy.
